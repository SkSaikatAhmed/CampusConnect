  ...
  const batchApprove = async () => {
    ...
    if (window.confirm(`Approve all ${data.length} pending notes?`)) {
      try {
        ...
        toast.error("Failed to approve some notes");
      }
    }
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
            <div>
              <div className="flex items-center mb-2">
                <div className="w-10 h-10 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-lg flex items-center justify-center shadow-md mr-3">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                  </svg>
                </div>
                <h1 className="text-3xl font-bold text-gray-800">Pending Notes Review</h1>
              </div>
              <p className="text-gray-600 mt-2">Review and approve student-submitted study notes</p>
            </div>
            <div className="mt-4 md:mt-0 flex items-center space-x-3">
              {data.length > 0 && (
                <button
                  onClick={batchApprove}
                  className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg font-medium shadow-md hover:from-green-600 hover:to-emerald-700 transition duration-200"
                >
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  Approve All ({data.length})
                </button>
              )}
              <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-teal-600 to-cyan-600 text-white rounded-lg font-medium shadow-md">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-white rounded-xl p-5 shadow-md border border-gray-200">
              <div className="text-2xl font-bold text-teal-600">{stats.total || 0}</div>
        ...
        {loading ? (
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <p className="mt-4 text-gray-600">Loading pending notes...</p>
          </div>
        ) : data.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">All Notes Reviewed!</h3>
            <p className="text-gray-600 max-w-md mx-auto">
              There are no pending notes submissions waiting for review. All submissions have been processed.
            </p>
          </div>
        ) : (
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-teal-50 to-cyan-50">
                  <div className="flex items-center justify-between">
                    <div>
                      <h2 className="text-lg font-semibold text-gray-800">Pending Notes</h2>
                      <p className="text-sm text-gray-600 mt-1">Sorted by submission time</p>
                    </div>
                ...
                <div className="max-h-[600px] overflow-y-auto">
                  {data.map(n => (
                    <div
                      ...
                      className={`p-5 border-b border-gray-100 hover:bg-teal-50 cursor-pointer transition duration-150 ${
                        selectedItem?._id === n._id ? 'bg-teal-50 border-l-4 border-l-teal-500' : ''
                      }`}
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center mb-2">
                            <div className="w-10 h-10 bg-gradient-to-r from-teal-100 to-cyan-100 rounded-lg flex items-center justify-center mr-3">
                              <svg className="w-5 h-5 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                              </svg>
                            </div>
                            <div>
                              <h3 className="font-semibold text-gray-800">{n.subject}</h3>
                              <div className="flex items-center text-sm text-gray-500 mt-1">
                                <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                Submitted {getTimeAgo(n.createdAt)}
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="mt-4 flex justify-end space-x-2">
                        <button
                          ...
                          className="px-3 py-1 text-xs font-medium text-white bg-green-500 rounded hover:bg-green-600 transition duration-150"
                        >
                          Approve
                        </button>
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            openRejectModal(n._id);
                          }}
                          className="px-3 py-1 text-xs font-medium text-white bg-red-500 rounded hover:bg-red-600 transition duration-150"
                        >
                          Reject
                        </button>
                      </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg sticky top-6">
                  <div className="p-6 border-b border-gray-200">
                    <div className="flex items-center justify-between mb-4">
                      <h2 className="text-xl font-bold text-gray-800">Notes Details</h2>
                      <button
    ...
    Email: {selectedItem.createdBy?.email}
                        ...
                        <div className="space-y-2 text-gray-600">
                          <div className="flex items-center">
                            ...
                            Submitted {getTimeAgo(selectedItem.createdAt)}
                          </div>
                          <div>
                      ...
                      <div>
                        ...
                        <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              <div className="w-12 h-12 bg-gradient-to-r from-red-100 to-pink-100 rounded-lg flex items-center justify-center mr-3">
                                <svg className="w-6 h-6 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                              </div>
                              <div>
                                <div className="font-medium text-gray-900">Study Notes</div>
                  ...
                  <div className="p-6 bg-gray-50 rounded-b-2xl">
                    ...
                    <div className="space-y-3">
                      <button
                        ...
                        className="w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-medium rounded-lg hover:from-green-600 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition duration-200"
                      >
                        <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                      ...
                      <button
                        ...
                        className="w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-red-500 to-pink-600 text-white font-medium rounded-lg hover:from-red-600 hover:to-pink-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition duration-200"
                      >
                        <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path>
                        </svg>
                    ...
                    <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                      <div className="flex items-start">
                        ...
                        <p className="text-sm text-blue-700">
                          Ensure the notes are relevant, properly formatted, and appropriate for academic use before approving.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-12 text-center flex flex-col items-center justify-center h-full">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Select Notes to Review</h3>
                  <p className="text-gray-600 max-w-md">
                    Click on any pending notes submission from the list to view detailed information, preview the document, and take review actions.
                  </p>
                </div>
              )}
            </div>
      ...
      {showRejectModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
            <h3 className="text-xl font-bold text-gray-800 mb-4">Reject Notes Submission</h3>
            <p className="text-gray-600 mb-6">
              Please provide constructive feedback for the student. This will help them improve future submissions.
            </p>
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-2">Common Rejection Reasons</label>
              <div className="flex flex-wrap gap-2">
                {['Poor quality', 'Wrong subject', 'Duplicate content', 'Format issues', 'Incomplete notes'].map(reason => (
                  <button
                    key={reason}
                    onClick={() => setRejectReason(prev => prev ? `${prev}, ${reason}` : reason)}
                    className="px-3 py-1 text-xs bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 transition duration-150"
                  >
                    {reason}
                  </button>
                ))}
